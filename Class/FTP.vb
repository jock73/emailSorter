...
#Region "CONSTRUCTORS"
        ...
        Sub New(ByVal Config As FTPconfig)

            _hostname = Config.ftpIP
...
#Region "Upload: File transfer TO ftp server"
        ...
        Public Function Upload(ByVal localFilename As String, ByVal DealerID As String, Optional ByVal targetFilename As String = "") As Boolean
            '1. check source
            ...
            Return Upload(fi, DealerID, targetFilename)
        End Function
        ...
        ''' <returns></returns>
        Public Function Upload(ByVal fi As FileInfo, ByVal DealerID As String, Optional ByVal targetFilename As String = "") As Boolean
            'copy the file specified to target file: target file can be full path or just filename (uses current dir)

            Dim FTPsucess As Boolean = False
            ...
            Using fs As FileStream = fi.OpenRead()
                ...
                Catch ex As Exception
                    ''  consoleshow(Indent(5) & "Move Fail" & ex.Message & NewLine)
                    '' sendErrorEmail(DealerID, company, "moving file" & fi.Name & "to" & "ftp server " & targetFilename & " failed: " & ex.Message)
                    Write("FTP ERROR" & ex.Message)
